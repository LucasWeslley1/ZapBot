...
echo -e " ${YELLOW} Olá"
echo -e " ${YELLOW} Todos os arquivos fundamentais serão instalados! aguarde..."
...
echo -e " ${YELLOW} Todos os arquivos foram instalados."
echo -e " ${YELLOW} Atualização: mudanças mínimas"
echo -e " ${YELLOW} Traduzido e modifcado por LucasW.. Base original por MhankBarBar"
echo -e " ${YELLOW} Use o comando: ${GREEN}npm start ${YELLOW}para iniciar o ZapBot."
